...
int main() {
	...
	Texture t;
	t.loadFromFile("C:/programick/C++/Project1/Paint/title.png");
	Sprite plat(t);

	Texture yw;
	yw.loadFromFile("C:/programick/C++/Project1/Paint/youwin.png");
	Sprite youwin(yw);
	youwin.setPosition(100, 210);

	Texture yl;
	yl.loadFromFile("C:/programick/C++/Project1/Paint/youlose.png");
	Sprite youlose(yl);
